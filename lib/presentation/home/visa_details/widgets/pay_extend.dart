...
class PayExtendVisaScreen extends StatelessWidget {
  File passport;
  File photo;
  File oldVisa;
  Datum model;

  PayExtendVisaScreen(this.passport, this.photo, this.oldVisa, this.model);
           ...
           DefaultButton(
                      ...
                      press: () {
                        if (ShopCubit.get(context).invoice == null) {
                          ...
                          ShopCubit.get(context).uploadExtendVisaFiles(
                            model.id,
                            model.filesNo,
                            passport,
                            photo,
